        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="d-flex flex-column align-items-center border text-center p-2 h-100">
                    ...
                    <h3>Address</h3>
                    <p class="text-muted fw-medium">Pallavi Model School, Narayankhed, Telangana
                    </p>
                </div>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                <div class="d-flex flex-column align-items-center h-100 border p-2">
                    ...
                    <h3>Email</h3>
                    <p class="text-muted fw-medium text-center">admissions_narayankhed@pallavimodelschools.org
                    </p>
                </div>
            </div>
        </div>
